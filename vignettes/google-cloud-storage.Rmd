...
Note: The following code chunks are not automatically evaluated due to the
...
```{r list_func, message=FALSE}
file_tbl <- listMetagenomicData()
```

```{r display_list, echo=FALSE}
...
```{r display_sample_meta, echo=FALSE}
...
```{r display_cache_meta, echo=FALSE}
...
```{r display_load_meta, echo=FALSE}
merged_experiment
```
...
```{r display_sw_add_meta, echo=FALSE}
