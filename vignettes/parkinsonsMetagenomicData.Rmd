...
separately with `parse_metaphlan_list`.
...
```{r}
parsed_bugs_list <- parse_metaphlan_list(cache_tbl$UUID[1], cache_tbl$cache_path[1], cache_tbl$data_type[1])
parsed_bugs_list
```

Once the files have been loaded as SummarizedExperiment objects, matching assays
from multiple samples can be merged together.

```{r}
to_merge <- getMetagenomicData(uuids = c("0001a4de-a907-46bd-8523-d7bfc1cdb544",
